...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "nml@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "nml API";

        private String description = "nml API documentation";
